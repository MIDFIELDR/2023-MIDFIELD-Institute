...
Install midfieldr from CRAN using the RStudio *Packages* tab as we did above, or type in the Console: 
...
If you are new to R (or new to the ggplot2 or data.table packages), we recommend you complete three pre-workshop  tutorials before the first day of the Institute to make your time with us that much more productive.

See the [Program](agenda.html#pre-workshop) for links and more information. 
