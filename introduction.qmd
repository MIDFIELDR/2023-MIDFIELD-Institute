...
The MIDFIELD Institute is a hands-on workshop that helps participants explore using the Multiple-Institution Database for Investigating Longitudinal Development (MIDFIELD).  In July 2023, the Institute will be an all-virtual meeting over several days.
...
As of June 1, 2022, MIDFIELD contains student-level records for 1.7&nbsp;M undergraduates at 19 US institutions. 
